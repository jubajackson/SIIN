...
Sys.Mvc.AddionMode.prototype = {
    replace: 0, 
    insertBefore: 1, 
    insertAfter: 2
}
Sys.Mvc.AddionMode.registerEnum('Sys.Mvc.AddionMode', false);
...
Sys.Mvc.AjaxContext = function Sys_Mvc_AjaxContext(request, updateTarget, loadingElement, insertionMode) {
    ...
    /// </param>
    /// <param name="insertionMode" type="Sys.Mvc.AddionMode">
    /// </param>
    /// <field name="_insertionMode" type="Sys.Mvc.AddionMode">
    /// </field>
...
Sys.Mvc.AjaxContext.prototype = {
    ...
    get_insertionMode: function Sys_Mvc_AjaxContext$get_insertionMode() {
        /// <value type="Sys.Mvc.AddionMode"></value>
...
Sys.Mvc.MvcHelpers.updateDomElement = function Sys_Mvc_MvcHelpers$updateDomElement(target, insertionMode, content) {
    ...
    if (target) {
        switch (insertionMode) {
            case Sys.Mvc.AddionMode.replace:
                target.innerHTML = content;
                break;
            case Sys.Mvc.AddionMode.insertBefore:
                if (content && content.length > 0) {
                    target.innerHTML = content + target.innerHTML.trimStart();
                }
                break;
            case Sys.Mvc.AddionMode.insertAfter:
                if (content && content.length > 0) {
